...
export const ArticlesCategoryOptions = {
...
export type ArticlesCategoryOptions = typeof ArticlesCategoryOptions[keyof typeof ArticlesCategoryOptions]

export const ArticlesStatusOptions = {
	"draft": "draft",
	"published": "published",
	"archived": "archived",
} as const
export type ArticlesStatusOptions = typeof ArticlesStatusOptions[keyof typeof ArticlesStatusOptions]
...
export type CommentsStatusOptions = typeof CommentsStatusOptions[keyof typeof CommentsStatusOptions]
export type CommentsRecord = {
	article: RecordIdString
	content: string
	id: string
	status?: CommentsStatusOptions
	user: RecordIdString
}
...
export type UsersInterestsOptions = typeof UsersInterestsOptions[keyof typeof UsersInterestsOptions]
